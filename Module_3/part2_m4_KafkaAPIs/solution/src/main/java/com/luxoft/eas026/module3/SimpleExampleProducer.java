...
public class SimpleExampleProducer {
   ...
   private static final String OUR_BOOTSTRAP_SERVERS = "localhost:9092, localhost:9093, localhost:9094";
    ...
    public static void main(String[] args){
        ...
        ProducerRecord<String, String> data = new ProducerRecord<>("events2", "key", "value");
        // create message for topic events2, no key
        ProducerRecord<String, String> data2 = new ProducerRecord<>("events2", "valueNoKey");

        // create message for topic events1, no key
        ProducerRecord<String, String> data1 = new ProducerRecord<>("events1",  "noKeyMessage");
