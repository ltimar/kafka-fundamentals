package com.luxoft.eas026.module3.Consumer;
...
public class ExampleConsumerGr {

	private static final Logger LOG = LoggerFactory.getLogger(ExampleConsumerGr.class);

	private static final String BOOTSTRAP_SERVERS = ":9092";
	private static final String GROUP_ID = "consGr1";
